...
#define RELEASE_SOCKET(x)               {if(x !=INVALID_SOCKET) { closesocket(x);x=INVALID_SOCKET;}}
	...
	extern router_server_config* p_router_server_config;/*全局配置*/
	...
	*****************************************************************/
	...
	/////////////////////////////////////////////////////////////////
	// init Socket
	bool ms_init_listen_socket(const router_server_config* p_router_server_config)
	{
		...
		ServerAddress.sin_addr.s_addr = inet_addr(p_router_server_config->server_ip);         
		ServerAddress.sin_port = htons(p_router_server_config->server_port);                          
	...
	bool ms_iocp_server_start(const router_server_config* p_router_server_config)/*启动IOCP服务*/
	{
		DWORD nThreadID;
		if(!load_socket_lib())
		{
		...
		if (false == ms_init_listen_socket(p_router_server_config))
		{
